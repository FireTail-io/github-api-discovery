...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("var grault = require('express');", {"grault"}),
        ("let grault = require('express');", {"grault"}),
        ("grault = require('express');", {"grault"}),
        ("const garply = waldo = require('express');", {"garply", "waldo"}),
        ("var garply = waldo = require('express');", {"garply", "waldo"}),
        ("let garply = waldo = require('express');", {"garply", "waldo"}),
        ("garply = waldo = require('express');", {"garply", "waldo"}),
        ...
        ("var grault = require('not-express');", set()),
        ("let grault = require('not-express');", set()),
        ("grault = require('not-express');", set()),
        ("const garply = waldo = require('not-express');", set()),
        ("var garply = waldo = require('not-express');", set()),
        ("let garply = waldo = require('not-express');", set()),
        ("garply = waldo = require('not-express');", set()),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("var bar = express()", {"express"}, {"bar"}),
        ("let bar = express()", {"express"}, {"bar"}),
        ("bar = express()", {"express"}, {"bar"}),
        ...
        ("var corge = express({ strict: false })", {"express"}, {"corge"}),
        ("let corge = express({ strict: false })", {"express"}, {"corge"}),
        ("corge = express({ strict: false })", {"express"}, {"corge"}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("var bar = express.Router()", {"express"}, {"bar"}),
        ("let bar = express.Router()", {"express"}, {"bar"}),
        ("bar = express.Router()", {"express"}, {"bar"}),
        ...
        ("var corge = express.Router({ strict: false })", {"express"}, {"corge"}),
        ("let corge = express.Router({ strict: false })", {"express"}, {"corge"}),
        ("corge = express.Router({ strict: false })", {"express"}, {"corge"}),
